...
import type { UpdateUserMutation, UpdateUserMutationVariables } from '@/graphql/generated.types'
...
export const AccountSettings = ({ opened, setOpened, userId }: Props): React.ReactNode => {
  /**
