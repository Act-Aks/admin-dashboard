import type * as Types from './generated.schema'
...
export type UpdateCompanyMutation = {
  updateOneCompany: Pick<
    Types.Company,
    'id' | 'name' | 'totalRevenue' | 'industry' | 'companySize' | 'businessType' | 'country' | 'website' | 'avatarUrl'
    ...
    nodes: Array<
      Pick<Types.DealStage, 'id' | 'title'> & {
        dealsAggregate: Array<{
          groupBy?: Types.Maybe<Pick<Types.DealStageDealsAggregateGroupBy, 'closeDateMonth' | 'closeDateYear'>>
