import { type Maybe } from '@/graphql/generated.schema'
 ...
 * @param startDate is string
 * @param endDate is string
 * @returns Date in the format "MMM DD, YYYY - HH:mm"
 */
export const getDate = (startDate: string, endDate: string): string => {
...
const filterDeal = (deal?: DealAggregate): Maybe<number> | undefined =>
